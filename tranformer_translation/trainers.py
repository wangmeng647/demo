...
class TransformerTrainer:
    ...
    def train(self, train_iter, tgt_vocab):
        model = self.model
        ...
        for i in range(self.config.epochs):
            ...
            for batch in train_iter:
                ...
                loss = model(en_in, en_len, de_en, tgt_vocab, de_len)
        ...
        for i in range(config.epochs):
            ...
            for batch in train_iter:
                ...
                for ppo_epoch in range(self.config.ppo_epochs):
                    ...
                    pg_loss, vf_loss = self.loss_compute(pro_update,
                                                         prob_base,
                                                         advantages,
                                                         value_update,
                                                         value_base,
